...
<body>
                                        ...
                                        <table class="table table-bordered table-striped fs--1 mb-0">
                                            <thead class="bg-200 text-900">
                                                <tr>
                                                    ...
                                                    <th class="sort" data-sort="age">test passer</th>
                                                    <th class="sort" data-sort="age">score</th>
                                            ...
                                            <tbody class="list">
                                                ...
                                                @foreach ($userpasseexment as $index => $u)
                                                    <tr>

                                                        <td class="name">{{ $index + 1 }}</td>
                                                        <td class="email">{{ $u->name }}</td>
                                                        <td class="age">{{ $u->email }}</td>
                                                        <td class="age">{{ $u->tech }}</td>
                                                        <td class="age">{{ $u->nbvrai }}%</td>
                                                        <td>
                                                            ...
                                                            <a type="button"
                                                                ...
                                                                href="/admin/question/destoryuser/{{ $u->id }}">Supprimer</a>
  ...
  fin modal --}}
      ...
      <div class="modal fade" id="categomodif{{ $u->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
          aria-hidden="true">
          <div class="modal-dialog">
              <div class="modal-content">
                  <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Modifier les donnes de : <span class="text-primary">{{ $u->name }}</span></h5><button class="btn p-1"
                          type="button" data-bs-dismiss="modal" aria-label="Close"><span
                              class="fas fa-times fs--1"></span></button>
                  ...
                  <form action="/admin/user/update" method="post" enctype="multipart/form-data">
                      ...
                      <div class="modal-body">
                          ...
                          <div class="mb-3"><label class="form-label" for="exampleFormControlInput1">nom de condidat
                              </label>
                              <input name="nom" class="form-control" id="exampleFormControlInput1" type="text" value="{{ $u->name }}"
                          ...
                          <div class="mb-0"><label class="form-label" placeholder='description...'
                                  for="exampleTextarea"> email  </label>
                              <textarea name="email" class="form-control" id="exampleTextarea" rows="3">{{ $u->email }}</textarea>
                          </div>
                          @error('email')
                              <div class="alert alert-danger"> {{ $message }}</div>
                          @enderror
